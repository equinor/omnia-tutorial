...
namespace EDC_API.Controllers
{
    ...
    public class ProductionDatasController : ControllerBase
    {
        ...
        public ActionResult<IEnumerable<ProductionData>> GetProductionData()
        {
        ...
        [HttpGet("production-data/{id}")]
        public ActionResult<ProductionData> GetProductionData(int id)
        {
        ...
        [HttpPut("production-data/{id}")]
        public IActionResult PutProductionData(int id, ProductionData productionData)
        {
        ...
        [HttpPost("production-data")]
        public ActionResult<ProductionData> PostProductionData(ProductionDataRequest request)
        {
        ...
        [HttpDelete("production-data/{id}")]
        public ActionResult<ProductionData> DeleteProductionData(int id)
        {
